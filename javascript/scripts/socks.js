...
For example, there are n = 7 socks with colors ar = [1,2,1,2,1,3,2]. There is one pair of color 1 and one of color 2. There 
are three odd socks left, one of each color. The number of pairs is 2.
...
function sockMerchant(n, ar) {
    ...
    for (let i = 0; i < n - 1; i++) {
        console.log(i, "sorted[i]: " + sorted[i], "sorted[i + 1]: " + sorted[i + 1]);
    ...
    return results.innerHTML = pairs;
}
